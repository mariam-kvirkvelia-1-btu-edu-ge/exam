...
def multipart_upload(aws_s3_client, bucket_name, file_path, file_name,
                     content_type):

  # https://docs.aws.amazon.com/AmazonS3/latest/userguide/qfacts.html
  PART_BYTES = 5 * 1024 * 1024
  mpu = aws_s3_client.create_multipart_upload(Bucket=bucket_name,
                                              Key=file_name,
...
def upload_local_file(aws_s3_client,
  ...
  if upload_type == "upload_file":
    ...
    multipart_upload(aws_s3_client, bucket_name, file_path, file_name,
                     content_type)
